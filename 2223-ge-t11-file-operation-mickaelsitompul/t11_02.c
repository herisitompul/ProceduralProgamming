...
int main(int _argc, char **_argv)
{
    ...
    fclose(reader);
                    ...
                    FILE* writerstd = fopen("./storage/student-repository.txt","a");
                    FILE* writerrm = fopen("./storage/dorm-repository.txt","a");
    ...
    while ( 1 ) {
        ...
        if ( strcmp(line, "---") == 0 ) break;
            ...
            if ( strcmp(token, "student-add") == 0 ) {
                ...
                if (success == 1) {
                    fputs(_id,writerstd);   fputs("|",writerstd);
                    fputs(_name,writerstd); fputs("|",writerstd);
                    fputs(_year,writerstd); fputs("|",writerstd);
                    fputs(token,writerstd); 
                    fputs("\n",writerstd);  
                }
            }
                ...
                if (success == 1) {
                    fputs(_name,writerrm);    fputs("|",writerrm);
                    fputs(capacity,writerrm); fputs("|",writerrm);
                    fputs(token,writerrm);
                    fputs("\n",writerrm);    
                }
            }
